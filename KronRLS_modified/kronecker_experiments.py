...
def load_kiba():
    Y = np.loadtxt(DATA_PATH + "kiba/" + "kiba_binding_affinity_v2.txt")
    XD = np.loadtxt(DATA_PATH + "kiba/" + "kiba_drug_sim.txt")
    XT = np.loadtxt(DATA_PATH + "kiba/" + "kiba_target_sim.txt")
    return XD, XT, Y
